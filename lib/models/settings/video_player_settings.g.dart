...
_VideoPlayerSettingsModel _$VideoPlayerSettingsModelFromJson(Map<String, dynamic> json) => _VideoPlayerSettingsModel(
      ...
      rememberPlaybackRate: json['rememberPlaybackRate'] as bool? ?? false,
      defaultPlaybackRate: (json['defaultPlaybackRate'] as num?)?.toDouble() ?? 1.0,
      lastPlaybackRate: (json['lastPlaybackRate'] as num?)?.toDouble(),
...
Map<String, dynamic> _$VideoPlayerSettingsModelToJson(_VideoPlayerSettingsModel instance) => <String, dynamic>{
      ...
      'rememberPlaybackRate': instance.rememberPlaybackRate,
      'defaultPlaybackRate': instance.defaultPlaybackRate,
      'lastPlaybackRate': instance.lastPlaybackRate,
